...
class Queries
{
    ...
    public const ADD_RESERVATION_ATTACHMENT =
        'INSERT INTO `reservation_files` (`series_id`, `file_name`, `file_type`, `file_size`, `file_extension`, `note`)
		VALUES (@seriesid, @file_name, @file_type, @file_size, @file_extension, @note)';
    ...
    public const UPDATE_RESERVATION_ATTACHMENT_NOTE =
        'UPDATE `reservation_files` SET `note` = @note WHERE `file_id` = @file_id';
