...
{
    public function __construct($fileName, $fileType, $fileSize, $fileExtension, $seriesId, $note = null)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::SERIES_ID, $seriesId));
        $this->AddParameter(new Parameter(ParameterNames::FILE_NOTE, $note));
    }
}
...
class UpdateReservationAttachmentNoteCommand extends SqlCommand
{
    public function __construct($fileId, $note)
    {
        parent::__construct(Queries::UPDATE_RESERVATION_ATTACHMENT_NOTE);
