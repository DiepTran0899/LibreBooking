...
{block name=header}
    ...
    <script src="{$Path}scripts/zalo-config.js?v=33.0" type="text/javascript"></script>
    <script src="{$Path}scripts/reservation-camera.js?v=33.0" type="text/javascript"></script>
