...
class vn_vn extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        //Camera Feature
        $strings['CapturePhoto'] = 'Chụp ảnh';
        $strings['AttachFile'] = 'Đính kèm file';
        $strings['TakePhoto'] = 'Chụp';
        $strings['RetakePhoto'] = 'Chụp lại';
        $strings['SavePhoto'] = 'Lưu ảnh';
        $strings['CameraTitle'] = 'Chụp ảnh từ Camera';
        $strings['Close'] = 'Đóng';
        $strings['CameraAccessDenied'] = 'Không thể truy cập camera. Vui lòng kiểm tra quyền truy cập.';
        $strings['InvalidFileType'] = 'Loại file không hợp lệ. Chỉ chấp nhận: %s';
        //End Camera Feature
